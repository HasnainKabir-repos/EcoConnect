  ...
  return (
    <>
            ...
            <div className="flex flex-col p-5 bg-white">
              ...
              <div className="w-full flex items-center justify-center mt-5">
                <button
                  ...
                  className="bg-gradient-to-r from-teal-600 to-cyan-600 py-4 text-center text-black rounded-lg font-bold w-2/3 h-12
      ...
      >
        ...
        <div>{formLoading ? <Loader /> : console.log("Form Loaded")}</div>
      </Modal>
    </>
  );
};
